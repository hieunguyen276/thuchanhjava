...
public class NhanVienFullTime extends NhanVien {
    private int ngayLamThem; //Tong so gio lam viec cua nhan vien
    ...
    public void tinhLuong() {
        if(loaiChucVu == 1 ){
        luong = Slide79.util.Configs.LUONG_NHAN_VIEN_FULL_TIME_SEP + Slide79.util.Configs.LUONG_LAM_THEM_MOI_NGAY * ngayLamThem;
        }else{
